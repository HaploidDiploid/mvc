...
<p class="dice-utf8">
<input type="checkbox" id="dice7" name="dice7" value="<?= $game21->getLastRoll() ?>">
<label for="dice7">
<i class="dice-<?= $game21->getLastRoll() ?>"></i>
</label>
<input type="checkbox" id="dice8" name="dice8" value="<?= $game212->getLastRoll2() ?>">
<label for="dice8">
...
if(isset($_POST["dice1"]))
{
    $sumpost1 = $sum_2dice + $_POST["dice1"];
}
if(isset($_POST["dice2"]))
{
    $sumpost1 = $sum_2dice + $_POST["dice2"];
}
echo null;
?><br>
